      ...
      <div className="relative p-5 sm:p-6">
        ...
        <div className="mt-5 grid gap-3 sm:grid-cols-5">
          ...
          <div className="grid gap-3 sm:col-span-2">
            <MiniStat icon={CalendarClock} label="Upcoming renewals" value="6" />
        ...
        <div className="mt-3 grid gap-3 md:grid-cols-2">
          ...
          <div className="flex flex-col justify-between rounded-xl bg-accent/12 p-4 ring-1 ring-inset ring-accent/25">
            ...
            <p className="mt-2 text-sm leading-relaxed text-navy-foreground/90">
              Review IRP renewal ahead of its 21-day window to keep operations
              uninterrupted.
            </p>
...
function StatusRing({ value }: StatusRingProps) {
  const radius = 26
...
function MiniStat({ icon: Icon, label, value, tone = 'default' }: MiniStatProps) {
  return (
