...
export default function RiskScreeningPage() {
  /*
   * STEP 1 = five questions, all answered on one screen
   * STEP 2 = company details — same form, next step
   */
  ...
  return (
    <main className="bg-white text-[#0c1a36]">
      ...
      <section className="bg-white">
        <div className="mx-auto max-w-7xl px-6 pb-16 pt-16 sm:px-8 lg:px-10 lg:pb-20 lg:pt-20">
          <div className="grid items-center gap-12 lg:grid-cols-[1.3fr_0.7fr] lg:gap-16">
            ...
            {/* Screening Overview — supplementary, kept visually secondary
                to the hero heading on purpose */}
            <div className="rounded-2xl bg-[#101c39] p-6 text-white shadow-[0_20px_45px_rgba(12,26,54,0.10)]">
              <SectionLabel
                label="Screening Overview"
                dark
              />

              <h2 className="mt-5 font-serif text-xl font-medium leading-[1.15] tracking-[-0.02em]">
              ...
              <p className="mt-4 max-w-xl text-xs leading-6 text-white/55">
                ...
                point using publicly available regulatory information.
              </p>
              ...
              <div className="mt-5 flex items-start gap-2.5 border-t border-white/10 pt-5">
                <ShieldCheck className="mt-0.5 h-3.5 w-3.5 shrink-0 text-[#e8720c]" />
      ...
      {/* ================================================================
          BEFORE YOU BEGIN
          FIRST SECTION OF THE PAGE — deliberately spaced apart from
          the hero above so it doesn't read as part of it.
      ================================================================ */}

      <section className="bg-white">
        <div className="mx-auto max-w-7xl px-6 pb-16 pt-10 sm:px-8 lg:px-10 lg:pb-20 lg:pt-14">
            ...
            <div className="grid gap-10 lg:grid-cols-[0.65fr_1.35fr] lg:gap-20">
              ...
              <div>
                ...
                <p className="mt-6 max-w-md text-sm leading-7 text-[#697589]">
                  These questions are not a compliance score. They simply
                  help frame where a closer look may be useful. Answer all
                  five, then continue straight to company details.
                </p>
              ...
              {/* All five questions, answered on one screen */}
              <div className="rounded-[24px] border border-[#dedbd3] bg-white p-6 shadow-[0_18px_45px_rgba(12,26,54,0.04)] sm:p-8 lg:p-10">
                <div className="divide-y divide-[#e6e2da]">
                  {questions.map((question, index) => (
                    ...
                    >
                      ...
                      <h3 className="mt-3 max-w-2xl text-lg font-semibold leading-[1.3] tracking-[-0.01em] text-[#101c39] sm:text-xl">
                        {question}
                      </h3>

                      <div className="mt-5 grid gap-3 sm:grid-cols-2">
                        <AnswerButton
                          selected={answers[index] === 'confident'}
                          onClick={() =>
                        ...
                        <AnswerButton
                          selected={answers[index] === 'unsure'}
                          warning
                          onClick={() => answerQuestion(index, 'unsure')}
                          icon={
                ...
                <div className="mt-8 flex flex-col gap-4 border-t border-[#e6e2da] pt-6 sm:flex-row sm:items-center sm:justify-between">
                  <p className="text-xs font-semibold text-[#7a8493]">
                  ...
                  <button
                    ...
                    onClick={goToForm}
                    className="inline-flex min-h-12 items-center justify-center gap-2 rounded-xl bg-[#e8720c] px-6 text-sm font-semibold text-white transition hover:bg-[#f17d1b] disabled:pointer-events-none disabled:opacity-30"
                  >
                  ...
                  <div className="text-white">
                    ...
                    <div className="mt-5 flex items-start gap-3">
                      ...
                      <p className="text-xs leading-5 text-white/40">
                        Your screening is based on publicly available
                      ...
                      >
                        ...
                        <div className="grid gap-5 sm:grid-cols-2">
                          <div>
                            ...
                            <div className="flex gap-2">
                              ...
                              {emailVerified ? (
                                <span className="inline-flex h-12 shrink-0 items-center gap-1.5 rounded-xl bg-[#eef7f0] px-3 text-xs font-semibold text-[#35563e]">
                                ...
                                <button
                                  ...
                                  className="h-12 shrink-0 rounded-xl border border-[#101c39] px-4 text-xs font-semibold text-[#101c39] transition hover:bg-[#101c39] hover:text-white disabled:pointer-events-none disabled:opacity-30"
                                >
                                  Verify
                                </button>
                              )}
                            ...
                            {otpSent && !emailVerified && (
                              <div className="mt-3 flex items-center gap-2 rounded-xl border border-[#d8dde3] bg-[#f7f5f0] p-3">
                                <input
                                  type="text"
                                  inputMode="numeric"
                                  maxLength={6}
                                  ...
                                  className="h-10 w-full rounded-lg border border-[#d8dde3] bg-white px-3 text-sm text-[#101c39] outline-none focus:border-[#101c39]"
                                />
                                ...
                                <button
                                  ...
                                  className="h-10 shrink-0 rounded-lg bg-[#101c39] px-4 text-xs font-semibold text-white transition hover:bg-[#172544] disabled:pointer-events-none disabled:opacity-30"
                                >
                                  Confirm
                                </button>
                              </div>
                            ...
                            <p className="mt-2 text-[11px] leading-4 text-[#8a929e]">
                              We'll email a code to confirm this address
                              before your screening can be submitted.
                            </p>
                          </div>
                        ...
                        <div className="border-t border-[#e4e1da] pt-6">
                          ...
                          <p className="mt-4 text-[11px] leading-5 text-[#697281]">
                            By submitting this request, you are asking
                            TruckEase to review publicly available regulatory
                            information related to the identifiers and
                            operating region provided above.
                          </p>
                        </div>
                      </form>
                    )}
